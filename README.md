...
- Widget de iOS para registrar suplementos: se configura al mantenerlo pulsado, admite hasta cuatro envases en tamaño mediano o doce en grande, y una única acción confirma el registro conjunto en Wellnario. Para suplementos por peso o volumen, la confirmación solicita la cantidad exacta.
